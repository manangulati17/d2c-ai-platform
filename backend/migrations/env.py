...
from models import merchant, metrics, agent_log
...
# Convert to asyncpg dialect for async support
...
# Set target_metadata to Base.metadata so Alembic can auto-detect models
